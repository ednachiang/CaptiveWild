...
```{r}
#png("../Fig1.WildCaptive.con.adiv.png", width = 170, height = 60, units = "mm", res = 600)
grid.newpage()
...
# PERMANOVA
p.adjust(c(0.0123, 0.0064, 0.0137), method = "fdr")
...
```{r}
#png("../Fig2.WildCaptive.con.bdiv.png", width = 85, height = 180, units = "mm", res = 600)
grid.newpage()
...
```{r}
#png("../FigS3.WildCaptive.muc.adiv.png", width = 170, height = 60, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,4, widths = c(1, 1, 1, 1.4), heights = c(0.07, 1.5))))
grid.text("A", x=unit(0.06, "npc"), vp=viewport(layout.pos.row=1, layout.pos.col=1),
          gp=gpar(fontsize=8,fontface="bold"))
...
# ANOSIM
p.adjust(c(0.0041, 0.0027, 0.003), method = "fdr")
...
```{r}
#png("../Fig.S4.WildCaptive.muc.bdiv.png", width = 85, height = 180, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(3,2, widths = c(1, 0.45), heights = c(1, 1, 1))))
