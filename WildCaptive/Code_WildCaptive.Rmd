...
#write.table(phyla.sum.df, "WildCaptive/Content/Table1.WildCaptive.con.Phyla.csv", sep=",")
```
...
```{r}
#tiff("WildCaptive/Content/Fig1.WildCaptive.con.adiv.tiff", width = 170, height = 60, units = "mm", res = 600)
grid.newpage()
...
```{r}
#tiff("WildCaptive/Content/Fig2.WildCaptive.con.bdiv.tiff", width = 85, height = 180, units = "mm", res = 600)
grid.newpage()
...
#write.table(phyla.muc.sum.df, "WildCaptive/Mucosa/TableS5.WildCaptive.muc.Phyla.csv", sep=",")
```
...
```{r}
#tiff("WildCaptive/Mucosa/FigS3.WildCaptive.muc.adiv.tiff", width = 170, height = 60, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,4, widths = c(1, 1, 1, 1.4), heights = c(0.07, 1.5))))
grid.text("A", x=unit(0.06, "npc"), vp=viewport(layout.pos.row=1, layout.pos.col=1),
          gp=gpar(fontsize=8,fontface="bold"))
...
```{r}
#tiff("WildCaptive/Mucosa/Fig.S4.WildCaptive.muc.bdiv.tiff", width = 85, height = 180, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(3,2, widths = c(1, 0.45), heights = c(1, 1, 1))))
...
#simper.pretty(data.frame(otu_table(phy.muc)),
              ...
              c("Diet"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='WildCaptive/Mucosa/WildCaptive.muc')
#group.muc.simper <- read.csv("WildCaptive/Mucosa/WildCaptive.muc_clean_simper.csv")
...
#group.muc.simper.kw <- read.csv("WildCaptive/Mucosa/WildCaptive.muc_krusk_simper.csv")
...
#write.table(group.muc.simper.kw, "WildCaptive/Mucosa/WildCaptive.muc_krusk_simper.csv", sep=",")
#group.muc.simper.kw <- read.csv("WildCaptive/Mucosa/WildCaptive.muc_clean_simper.csv", row.names = 1)
```
