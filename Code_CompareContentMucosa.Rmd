...
otu.ann <- data.frame(lab = c("ns", " "), Sample_Type = faciba(c("Content", "Mucosa")))
...
pd.ann <- data.frame(lab = c("ns", " "), Sample_Type = faciba(c("Content", "Mucosa")))
...
mpd.ann <- data.frame(lab = c("ns", " "), Sample_Type = faciba(c("Content", "Mucosa")))
...
shannon.ann <- data.frame(lab = c("ns", " "), Sample_Type = faciba(c("Content", "Mucosa")))
...
otu.ann <- data.frame(lab = c("ns", " "), Sample_Type = facspr(c("Content", "Mucosa")))
...
pd.ann <- data.frame(lab = c("ns", " "), Sample_Type = facspr(c("Content", "Mucosa")))
...
mpd.ann <- data.frame(lab = c("ns", " "), Sample_Type = facspr(c("Content", "Mucosa")))
...
shannon.ann <- data.frame(lab = c("ns", " "), Sample_Type = facspr(c("Content", "Mucosa")))
...
```{r}
tiff("ConMuc.adiv.tiff", width = 170, height = 300, units = "mm", res = 600)
grid.newpage()
