...
wUF.plot <- plot_ordination(physeq = physeq.wild, ordination = UF.w.pcoa, axes = c(1,2),
                title = "Weighted UniFrac", color = "Sample_Type") +
...
uUF.plot <- plot_ordination(physeq = physeq.wild, ordination = UF.w.pcoa, axes = c(1,2),
                title = "Weighted UniFrac", color = "Sample_Type") +
  #stat_ellipse(aes(colour = Sample_Type), size = 1, level = 0.95) +
  #scale_colour_manual(values = c("#e60000", "#ec9393", "#1c41b0", "deepskyblue", "#74b300"), labels = c("Summer Wild", "Summer Lab", "Torpor", "IBA", "Spring")) +
  theme(panel.grid.major = element_blank(),
