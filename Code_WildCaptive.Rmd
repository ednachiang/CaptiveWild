...
#simper.pretty(data.frame(otu_table(phy.con)),
              ...
              output_name='wild.captive')
group.simper <- read.csv("wild.captive_clean_simper.csv")
...
#group.simper.kw <- read.csv("wild.captive_krusk_simper.csv")
...
#write.table(group.simper.kw, "wild.captive_krusk_simper.csv", sep=",")
