...
phy.sum <- phy99.df %>%
  ...
  summarize(Mean = mean(Abundance),
            ...
            SE = se(Abundance),
            iqr = IQR(Abundance))
group.renamed <- as_labeller(c(`Summer_Captive` = "Summer", `Torpor` = "Torpor", `IBA` = "IBA", `Spring` = "Spring"))
...
#dev.off()
```
### Alpha-Diversity - Phylogenetic Diversity and SES MPD
```{r}
...
summary(aov(Stat ~ Group, data = pd.ready))
  # p-value = 0.000299
TukeyHSD(aov(Stat ~ Group, data = pd.ready))
  # Summer-Torpor = 0.0011196*
  # Summer-IBA = 0.0010730*
  # Summer-Spring = 0.5133391
  # Torpor-IBA = 0.9948681
  # Torpor-Spring = 0.2593828
  # IBA-Spring = 0.3179979
