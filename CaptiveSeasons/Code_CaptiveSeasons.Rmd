...
```{r}
#png("../Fig3.CaptiveSeasons.adiv.png", width = 170, height = 60, units = "mm", res = 600)
grid.newpage()
...
```{r}
#png("../Fig4.CaptiveSeasons.con.bdiv.png", width = 85, height = 180, units = "mm", res = 600)
grid.newpage()
...
```{r}
#("../FigS5.CaptiveSeasons.muc.adiv.png", width = 170, height = 60, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,4, widths = c(1, 1, 1, 1.4), heights = c(0.07, 1.5))))
grid.text("A", x=unit(0.03, "npc"), vp=viewport(layout.pos.row=1, layout.pos.col=1),
          gp=gpar(fontsize=8,fontface="bold"))
...
```{r}
#png("../FigS6.CaptiveSeasons.muc.bdiv.png", width = 85, height = 180, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(3,2, widths = c(1, 0.45), heights = c(1, 1, 1))))
