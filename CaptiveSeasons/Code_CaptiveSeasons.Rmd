...
```{r}
#tiff("CaptiveSeasons/Content/Fig3.CaptiveSeasons.adiv.tiff", width = 170, height = 60, units = "mm", res = 600)
grid.newpage()
...
```{r}
#tiff("CaptiveSeasons/Content/Fig4.CaptiveSeasons.con.bdiv.tiff", width = 85, height = 180, units = "mm", res = 600)
grid.newpage()
...
#simper.pretty(data.frame(otu_table(phy.con.simp)),
              ...
              output_name='CaptiveSeasons/Content/CaptiveSeasons.con')
#group.simper <- read.csv("CaptiveSeasons/Content/CaptiveSeasons.con_clean_simper.csv")
...
#group.simper.kw <- read.csv("CaptiveSeasons/Content/CaptiveSeasons.con_krusk_simper.csv")
...
#write.table(group.simper.kw, "CaptiveSeasons/Content/CaptiveSeasons.con_krusk_simper.csv", sep=",")
#group.simper.kw <- read.csv("CaptiveSeasons/Content/CaptiveSeasons.con_krusk_simper.csv", row.names = 1)
```
...
#write.csv(data.frame(tax_table(phy.con.core)), "CaptiveSeasons/Content/CaptiveSeasons_con_coreOTUs.csv")
```
...
```{r}
#tiff("CaptiveSeasons/Mucosa/FigS5.CaptiveSeasons.muc.adiv.tiff", width = 170, height = 60, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,4, widths = c(1, 1, 1, 1.4), heights = c(0.07, 1.5))))
grid.text("A", x=unit(0.03, "npc"), vp=viewport(layout.pos.row=1, layout.pos.col=1),
          gp=gpar(fontsize=8,fontface="bold"))
...
```{r}
#tiff("CaptiveSeasons/Mucosa/FigS6.CaptiveSeasons.muc.bdiv.tiff", width = 85, height = 180, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(3,2, widths = c(1, 0.45), heights = c(1, 1, 1))))
...
#simper.pretty(data.frame(otu_table(phy.muc.simp)),
              ...
              c("GroupRename"),
              perc_cutoff=0.5, low_cutoff='y', low_val=0.01,
              output_name='CaptiveSeasons/Mucosa/CaptiveSeasons.muc')
#group.simper <- read.csv("CaptiveSeasons/Mucosa/CaptiveSeasons.muc_clean_simper.csv")
...
#group.simper.kw <- read.csv("CaptiveSeasons/Mucosa/CaptiveSeasons.muc_krusk_simper.csv")
for(i in 1:nrow(group.simper.kw)){
...
#write.table(group.simper.kw, "CaptiveSeasons/Mucosa/CaptiveSeasons.muc_krusk_simper.csv", sep=",")
#group.simper.kw <- read.csv("CaptiveSeasons/Mucosa/CaptiveSeasons.muc_krusk_simper.csv", row.names = 1)
```
...
#write.csv(data.frame(tax_table(phy.muc.core)), "CaptiveSeasons/Mucosa/CaptiveSeasons_muc_coreOTUs.csv")
```