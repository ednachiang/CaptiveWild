...
physeq.rem <- subset_samples(physeq.rem, Sample != "CC1_916_P" & Sample != "CM1_P16_P" & Sample != "CC1_925_I")
...
# Total OTUs
otu.tot <- data.frame(sample_names(physeq.rem))

# Pull out # of OTUs for all samples
otu.tot$Total_OTUs <- rep("NA", nrow(adiv))
for(i in 1:nrow(otu.tot)){
  otu.tot[i,2] <- length(which(otu_table(physeq.rem)[,i] != 0))
}
colnames(otu.tot) <- c("Sample", "Total_OTUs")
otu.tot$Total_OTUs <- as.integer(otu.tot$Total_OTUs)
...
##### Total OTUs #####
hist(adiv.wild$Total_OTUs, breaks=10)
qqnorm(adiv.wild$Total_OTUs)
qqline(adiv.wild$Total_OTUs)
shapiro.test(adiv.wild$Total_OTUs)
  # p-value = 0.5486
  # Normal
hist(adiv.sum$Total_OTUs, breaks=10)
qqnorm(adiv.sum$Total_OTUs)
qqline(adiv.sum$Total_OTUs)
shapiro.test(adiv.sum$Total_OTUs)
  # p-value = 0.1322
  # Normal
hist(adiv.tor$Total_OTUs, breaks=10)
qqnorm(adiv.tor$Total_OTUs)
qqline(adiv.tor$Total_OTUs)
shapiro.test(adiv.tor$Total_OTUs)
  # p-value = 0.8896
  # Normal
hist(adiv.iba$Total_OTUs, breaks=10)
qqnorm(adiv.iba$Total_OTUs)
qqline(adiv.iba$Total_OTUs)
shapiro.test(adiv.iba$Total_OTUs)
  # p-value = 0.001198
  # Not Normal
hist(adiv.spr$Total_OTUs, breaks=10)
qqnorm(adiv.spr$Total_OTUs)
qqline(adiv.spr$Total_OTUs)
shapiro.test(adiv.spr$Total_OTUs)
  # p-value = 0.05006
  # Normal

### Wilcoxon & T-Test ###
t.test(Total_OTUs ~ Sample_Type, data = adiv.wild)
  # p-value = 0.4662
t.test(Total_OTUs ~ Sample_Type, data = adiv.sum)
  # p-value = 0.7803
t.test(Total_OTUs ~ Sample_Type, data = adiv.tor)
  # p-value = 0.7372
wilcox.test(Total_OTUs ~ Sample_Type, data = adiv.iba)
  # p-value = 0.1807
t.test(Total_OTUs ~ Sample_Type, data = adiv.spr)
  # p-value = 0.9702


##### Bergerparker #####
hist(adiv.wild$bergerparker, breaks=10)
qqnorm(adiv.wild$bergerparker)
qqline(adiv.wild$bergerparker)
shapiro.test(adiv.wild$bergerparker)
  # p-value = 0.03423
  # Not Normal
hist(adiv.sum$bergerparker, breaks=10)
qqnorm(adiv.sum$bergerparker)
qqline(adiv.sum$bergerparker)
shapiro.test(adiv.sum$bergerparker)
  # p-value = 0.06637
  # Normal
hist(adiv.tor$bergerparker, breaks=10)
qqnorm(adiv.tor$bergerparker)
qqline(adiv.tor$bergerparker)
shapiro.test(adiv.tor$bergerparker)
  # p-value = 0.2771
  # Normal
hist(adiv.iba$bergerparker, breaks=10)
qqnorm(adiv.iba$bergerparker)
qqline(adiv.iba$bergerparker)
shapiro.test(adiv.iba$bergerparker)
  # p-value = 0.04348
  # Not Normal
hist(adiv.spr$bergerparker, breaks=10)
qqnorm(adiv.spr$bergerparker)
qqline(adiv.spr$bergerparker)
shapiro.test(adiv.spr$bergerparker)
  # p-value = 0.05511
  # Normal

### Wilcoxon & T-Test ###
wilcox.test(bergerparker ~ Sample_Type, data = adiv.wild)
  # p-value = 0.4
t.test(bergerparker ~ Sample_Type, data = adiv.sum)
  # p-value = 0.2892
t.test(bergerparker ~ Sample_Type, data = adiv.tor)
  # p-value = 0.7082
wilcox.test(bergerparker ~ Sample_Type, data = adiv.iba)
  # p-value = 1
t.test(bergerparker ~ Sample_Type, data = adiv.spr)
  # p-value = 0.0977
...
# Total OTUs by Sample Type & Season
#tiff("totalOTUs.tiff", width = 17, height = 4, units="in", res = 600)
ggplot(adiv, aes(x=Group, y=Total_OTUs, colour = Group)) +
  geom_jitter(width=0.25, aes(colour = Group), size=3) + 
  facet_grid(.~ Sample_Type) +
  scale_colour_manual(values=c("brown2", "lightcoral", "royalblue3", "deepskyblue", "limegreen")) +
  scale_y_continuous(limits=c(0,800), breaks=c(0,200,400,600,800), expand=c(0,0)) +
  xlab("Group") +
  ylab("Total OTUs") +
...
##### Total OTUs #####
con.otu.tot <- data.frame(sample_names(physeq.con))
muc.otu.tot <- data.frame(sample_names(physeq.muc))

# Pull out # of OTUs for all samples
con.otu.tot$Total_OTUs <- rep("NA", nrow(adiv.con))
for(i in 1:nrow(con.otu.tot)){
  con.otu.tot[i,2] <- length(which(otu_table(physeq.con)[,i] != 0))
}
muc.otu.tot$Total_OTUs <- rep("NA", nrow(adiv.muc))
for(i in 1:nrow(muc.otu.tot)){
  muc.otu.tot[i,2] <- length(which(otu_table(physeq.muc)[,i] != 0))
}

# Organize data
colnames(con.otu.tot) <- c("Sample", "Total_OTUs")
con.otu.tot$Total_OTUs <- as.integer(con.otu.tot$Total_OTUs)
adiv.con$Total_OTUs <- con.otu.tot$Total_OTUs
colnames(muc.otu.tot) <- c("Sample", "Total_OTUs")
muc.otu.tot$Total_OTUs <- as.integer(muc.otu.tot$Total_OTUs)
adiv.muc$Total_OTUs <- muc.otu.tot$Total_OTUs

# Content Total OTUs by Season
ggplot(adiv.con, aes(x=Group, y=Total_OTUs, fill = Group)) +
...
# Mucosa Total OTUs by Season
ggplot(adiv.muc, aes(x=Group, y=Total_OTUs, fill = Group)) +
  geom_boxplot(position=position_dodge(1)) +
  geom_point() + 
  scale_fill_manual(values=c("brown2", "lightcoral", "royalblue3", "deepskyblue", "limegreen")) +
  xlab("Group") +
...
# Test normality
hist(adiv.con$Total_OTUs, breaks=10)
qqnorm(adiv.con$Total_OTUs)
qqline(adiv.con$Total_OTUs)
shapiro.test(adiv.con$Total_OTUs)
  # p-value = 0.02096
  # Not Normal
hist(adiv.muc$Total_OTUs, breaks=10)
qqnorm(adiv.muc$Total_OTUs)
qqline(adiv.muc$Total_OTUs)
shapiro.test(adiv.muc$Total_OTUs)
  # p-value = 0.001562
  # Not Normal

# Kruskal-Wallis
kruskal.test(formula = Total_OTUs ~ Group, data = adiv.con)
  # p-value = 0.01682
kruskalmc(resp = Total_OTUs ~ Group, data = adiv.con)
  # Summer_Wild - IBA
kruskal.test(formula = Total_OTUs ~ Group, data = adiv.muc)
  # p-value = 0.03301
kruskalmc(resp = Total_OTUs ~ Group, data = adiv.muc)
  # Summer_Wild - Torpor
# Con/Muc combined
kruskal.test(formula = Total_OTUs ~ Group, data = adiv)
  # p-value = 7.235e-05
kruskalmc(resp = Total_OTUs ~ Group, data = adiv)
  # Summer_Wild-Torpor
  # Summer_Wild-IBA
...
##### Bergerparker #####
hist(adiv.con$bergerparker, breaks=10)
qqnorm(adiv.con$bergerparker)
qqline(adiv.con$bergerparker)
shapiro.test(adiv.con$bergerparker)
  # p-value = 0.001532
  # Not Normal
hist(adiv.muc$bergerparker, breaks=10)
qqnorm(adiv.muc$bergerparker)
qqline(adiv.muc$bergerparker)
shapiro.test(adiv.muc$bergerparker)
  # p-value = 0.07078
  # Normal, but for consistency I'll use kruskal-wallis

# Kruskal-Wallis
kruskal.test(formula = bergerparker ~ Group, data = adiv.con)
  # p-value = 0.05109
kruskalmc(resp = bergerparker ~ Group, data = adiv.con)
  # Summer_Wild-Spring
kruskal.test(formula = bergerparker ~ Group, data = adiv.muc)
  # p-value = 0.7597
# Con/muc combined
...
TukeyHSD(aov(shannon ~ Group, data = adiv.con))
  # Summer_Lab-Summer_Wild = 0.0295232*
  # Torpor-Summer_Wild = 0.1006389
  # IBA-Summer_Wild = 0.1280457
  # Spring-Summer_Wild = 0.0005253***
  # Torpor-Summer_Lab = 0.9827592
  # IBA-Summer_Lab = 0.9165038
  # Spring-Summer_Lab = 0.1118792
  # IBA-Torpor = 0.1118792
  # Spring-Torpor = 0.0629667
  # Spring-IBA = 0.0306479*
summary(aov(shannon ~ Group, data = adiv.muc))
  # p-value = 0.763
summary(aov(shannon ~ Group, data = adiv))
  # p-value = 0.0146
TukeyHSD(aov(shannon ~ Group, data = adiv))
  # Summer_Lab-Summer_Wild = 0.2033311
  # Torpor-Summer_Wild = 0.1326307
  # IBA-Summer_Wild = 0.1929768
  # Spring-Summer_Wild = 0.0050119**
  # Torpor-Summer_Lab = 0.9980613
  # IBA-Summer_Lab = 0.9999993
  # Spring-Summer_Lab = 0.2917135
  # IBA-Torpor = 0.9964366
  # Spring-Torpor = 0.4592940
  # Spring-IBA = 0.2472826



##### Inverse Simpson #####
hist(adiv.con$invsimpson, breaks=10)
qqnorm(adiv.con$invsimpson)
qqline(adiv.con$invsimpson)
shapiro.test(adiv.con$invsimpson)
  # p-value = 0.001667
  # Not Normal
hist(adiv.muc$invsimpson, breaks=10)
qqnorm(adiv.muc$invsimpson)
qqline(adiv.muc$invsimpson)
shapiro.test(adiv.muc$invsimpson)
  # p-value = 0.0002469
  # Not Normal

# Kruskal-Wallis
kruskal.test(formula = invsimpson ~ Group, data = adiv.con)
  # p-value = 0.02212
kruskalmc(resp = invsimpson ~ Group, data = adiv.con)
  # Summer_Wild-Spring
kruskal.test(formula = invsimpson ~ Group, data = adiv.muc)
  # p-value = 0.8751
# Con/muc combined
...
tiff("InvSimp.mdtp.tiff", width=8.5, height=4.75, units="in", res=600)
ggplot(adiv, aes(x=Group, y= invsimpson, fill = Group)) +
  geom_boxplot(position=position_dodge(1)) +
  geom_point() + 
  #facet_grid(.~Substrate) +
...
adonis(bray ~ Group, data = sampdf)
  # 0.001
pairwise.adonis(as.matrix(bray), sampdf$Group, sim.method = "bray", p.adjust.m = "fdr")
  # Summer_Wild vs Summer_Lab = .000133*
  # Summer_Wild vs IBA = .0000666*
  # Summer_Wild vs Torpor = .0001571429*
  # Summer_Wild vs Spring = .003012500*
  # Summer_Lab vs IBA = .00005*
  # Summer_Lab vs Torpor = .00005*
  # Summer_Lab vs Spring = .08254444
  # IBA vs Torpor = .2627900
  # IBA vs Spring = .0001*
  # Torpor vs SprinG = .0001333333*
...
adonis(bray.con ~ Group, data = sampdf.con)
  # p-value = 0.001
pairwise.adonis(as.matrix(bray.con), sampdf.con$Group, sim.method = "bray", p.adjust.m = "fdr")
  # Summer_Wild vs Summer_Lab = 0.03571429*
  # Summer_Wild vs IBA = 0.03890000*
  # Summer_Wild vs Torpor = 0.03571429*
  # Summer_Wild vs Spring = 0.10714286
  # Summer_Lab vs IBA = 0.00760000*
  # Summer_Lab vs Torpor = 0.01755000*
  # Summer_Lab vs Spring = 0.29847778
  # IBA vs Torpor = 0.33044000
  # IBA vs Spring = 0.07424286
  # Torpor vs Spring = 0.02613333*
...
pairwise.adonis(as.matrix(bray.muc), sampdf.muc$Group, sim.method = "bray", p.adjust.m = "fdr")
  # Summer_Wild vs Summer_Lab = 0.08163265
  # Summer_Wild vs IBA = 0.02190000*
  # Summer_Wild vs Torpor = 0.02976190*
  # Summer_Wild vs Spring = 0.25000000
  # Summer_Lab vs IBA = 0.02190000*
  # Summer_Lab vs Torpor = 0.02190000*
  # Summer_Lab vs Spring = 0.63492063
  # IBA vs Torpor = 0.78103000
  # IBA vs Spring = 0.02190000*
...
wilcox.test(chao ~ Diet, data=adiv)
  # p-value = 0.002454
kruskal.test(formula = chao ~ Sex, data = adiv)
  # p-value = 0.2632
kruskal.test(formula = chao ~ Sex, data = adiv, subset=Diet=="Lab")
  # p-value = 0.3634
kruskal.test(formula = chao ~ Sex, data = adiv, subset=Group=="Summer_Lab")
  # p-value = 0.5708
kruskal.test(formula = chao ~ Sex, data = adiv, subset=Group=="Torpor")
  # p-value = 0.8312
kruskal.test(formula = chao ~ Sex, data = adiv, subset=Group=="IBA")
  # p-value = 0.5677
kruskal.test(formula = chao ~ Sex, data = adiv, subset=Group=="Spring")
  # p-value = 0.4386
...
wilcox.test(bergerparker ~ Diet, data=adiv)
  # p-value = 0.03743
kruskal.test(formula = bergerparker ~ Sex, data = adiv)
  # p-value = 0.3438
kruskal.test(formula = bergerparker ~ Sex, data = adiv, subset=Diet=="Lab")
  # p-value = 0.2396
kruskal.test(formula = bergerparker ~ Sex, data = adiv, subset=Group=="Summer_Lab")
  # p-value = 0.4497
kruskal.test(formula = bergerparker ~ Sex, data = adiv, subset=Group=="Torpor")
  # p-value = 1
kruskal.test(formula = bergerparker ~ Sex, data = adiv, subset=Group=="IBA")
  # p-value = 0.06329
kruskal.test(formula = bergerparker ~ Sex, data = adiv, subset=Group=="Spring")
  # p-value = 1
...
t.test(shannon ~ Diet, data=adiv)
  # p-value = 0.02371
summary(aov(shannon ~ Sex, data=adiv))
  # p-value = 0.718
...
wilcox.test(invsimpson ~ Diet, data=adiv)
  # p-value = 0.0239
kruskal.test(formula = invsimpson ~ Sex, data = adiv)
  # p-value = 0.2725
kruskal.test(formula = invsimpson ~ Sex, data = adiv, subset=Diet=="Lab")
  # p-value = 0.1995
kruskal.test(formula = invsimpson ~ Sex, data = adiv, subset=Group=="Summer_Lab")
  # p-value = 0.4497
kruskal.test(formula = invsimpson ~ Sex, data = adiv, subset=Group=="Torpor")
  # p-value = 0.5224
kruskal.test(formula = invsimpson ~ Sex, data = adiv, subset=Group=="IBA")
  # p-value = 0.2531
kruskal.test(formula = invsimpson ~ Sex, data = adiv, subset=Group=="Spring")
  # p-value = 1
...
p$tab
  # p-value = 0.192
adonis(bray~ Group*Sex*Sample_Type, data=sampdf)
  # Group
    # p-value = 0.001    
    # R2 = 0.27974
  # Sex
