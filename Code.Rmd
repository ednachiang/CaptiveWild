...
t.test(Total_OTUs ~ Sample_Type, data = adiv.tor)
  # p-value = 0.7268
t.test(Total_OTUs ~ Sample_Type, data = adiv.iba)
  # p-value = 0.4543
...
pairwise.adonis(as.matrix(bray), sampdf$Group, sim.method = "bray", p.adjust.m = "fdr")
  # Summer_Wild vs Summer_Lab = 0.000175*
  # Summer_Wild vs IBA = 0.000175*
  # Summer_Wild vs Torpor = 0.0002*
  # Summer_Wild vs Spring = 0.0025375*
  # Summer_Lab vs IBA = 0.00005*
  # Summer_Lab vs Torpor = 0.00005*
  # Summer_Lab vs Spring = 0.07272
  # IBA vs Torpor = 0.32849
  # IBA vs Spring = 0.0002*
  # Torpor vs SprinG = 0.0004857143*
