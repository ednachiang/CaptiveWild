...
p.adjust(c(3.367e-08, 0.0003114, 0.0008299, 0.003129, 0.02357, 0.01903, 6.982e-05, 0.002416, 0.0614, 0.01184, 0.01184), method = "fdr")
  # Firmicutes = 3.703700e-07
  # Bacteroidetes = 0.001141800e
  # Verrucomicrobia = 0.002282225
  # Proteobacteria = 0.005736500e
  # Unclassified = 0.02592700
  # Kiritimatiellaeota = 0.02325889
  # Cyanobacteria = 3.840100e-04
  # Tenericutes = 0.005315200
  # Actinobacteria = 0.06140000
  # Elusimicrobia = 0.01628000
  # Epsilonbacteraeota = 0.01628000
...
w.simp.plot <- ggplot(w.sig.sum, aes(x = Group, y = Species, fill = Mean)) +
  ...
  scale_fill_gradientn(name = "Mean\nRelative\nAbundance\n(%)", limits = c(0, 2.4),
                       breaks = c(0, 1.2, 2.4),
                       labels = c("0", "1.2", "2.4"),
                       colours = c("#fff5f5", "#ffebe6", "#ffad99", "#ec5746")) +
...
s.simp.plot <- ggplot(s.sig.sum, aes(x = Group, y = Species, fill = Mean)) +
  ...
  scale_y_discrete(labels = c(expression(" "^abc~"Lachnospiraceae"), 
                              expression(" "^ab~italic("NK4A136")), 
                              expression(" "^ab~"Bacteroidales"), 
                              expression(" "^ab~italic("Ruminococcus 1")), 
                              expression(" "^a~"Lachnospiraceae"), 
                              expression(" "^X~italic("Lactobacillus")))) +
  scale_fill_gradientn(name = "Mean\nRelative\nAbundance\n(%)", limits = c(0, 12),
                       breaks = c(0, 6, 12),
                       labels = c("0", "6", "12"),
                       colours = c("#fff0f3", "#e4677e")) +
...
t.simp.plot <- ggplot(t.sig.sum, aes(x = Group, y = Species, fill = Mean)) +
  ...
  scale_x_discrete(position = "top", labels = c("Summer Wild", "Summer Lab", "Torpor",
                                                "IBA", "Spring")) +
  ylab("OTU Taxonomic Classification") + xlab("Group\n") +
  scale_y_discrete(labels = c(expression(" "^abc~italic("Odoribacter")),
                              expression(" "^ab~italic("Bacteroides")),
                              "Kiritimatiellae\nWCHB1-41")) +
  scale_fill_gradientn(name = "Mean\nRelative\nAbundance\n(%)", limits = c(0, 11.4),
                       breaks = c(0, 5.7, 11.4),
                       labels = c("0", "5.7", "11.4"),
                       colours = c("#FFFFFF", "#ebecfa", "#c9c6eb", "#a4a0de",
                                   "#807ad1")) +
...
i.simp.plot <- ggplot(i.sig.sum, aes(x = Group, y = Species, fill = Mean)) +
  ...
  scale_x_discrete(position = "top", labels = c("Summer Wild", "Summer Lab", "Torpor",
                                                "IBA", "Spring")) +
  ylab("OTU Taxonomic Classification") + xlab("Group\n") +
  scale_y_discrete(labels = c(expression(" "^ab~italic("Akkermansia")),
                              expression(" "^a~italic("Odoribacter")))) +
  scale_fill_gradientn(name = "Mean\nRelative\nAbundance\n(%)", limits = c(0, 17.6),
                       breaks = c(0, 8.8, 17.6),
                       labels = c("0", "8.8", "17.6"),
                       colours = c("#e6f9ff", "#66d9ff", "#00ace6")) +
  theme(axis.text.x = element_text(size = 8, color = "black", angle = 50, hjust = 0),
        axis.text.y = element_text(size=8, color = "black"),
        axis.ticks.x = element_blank(),
        axis.ticks.y = element_blank(),
...
p.simp.plot <- ggplot(p.sig.sum, aes(x = Group, y = Species, fill = Mean)) +
  ...
  scale_x_discrete(position = "top", labels = c("Summer Wild", "Summer Lab", "Torpor",
                                                "IBA", "Spring")) +
  ylab("OTU Taxonomic Classification") + xlab("Group\n") +
  scale_y_discrete(labels = c(expression(" "^ab~italic("Lactobacillus")),
                              expression(" "^ab~italic("Coprococcus 2")),
                              expression(" "^ab~"Lachnospiraceae"),
                              expression(" "^a~italic("Bacteroides")),
                              expression(italic("Prevotellaceae\nUCG-001")))) +
  scale_fill_gradientn(name = "Mean\nRelative\nAbundance\n(%)", limits = c(0, 6.8),
                       breaks = c(0, 1.7, 3.4, 5.1, 6.8),
                       labels = c("0", "1.7", "3.4", "5.1", "6.8"),
                       colours = c("#f4fbf4", "#6fdc6f", "#46d246", "#2db92d")) +
  theme(axis.text.x = element_text(size = 8, color = "black", angle = 50, hjust = 0),
        axis.text.y = element_text(size=8, color = "black"),
        axis.ticks.x = element_blank(),
        axis.ticks.y = element_blank(),
...
grid.text(expression(italic("Prevotellaceae\nUCG-003")),
