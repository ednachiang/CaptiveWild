...
grid.text("A", x=unit(0.03, "npc"), y=unit(0.974, "npc"), vp=viewport(layout.pos.row=1, layout.pos.col=1), gp=gpar(fontsize=16,fontface="bold"))
grid.text("B", x=unit(0.03, "npc"), y=unit(0.974, "npc"), vp=viewport(layout.pos.row=1, layout.pos.col=2),gp=gpar(fontsize=16,fontface="bold"))
...
grid.text("stress = 0.141", x=unit(0.6, "npc"), y=unit(0.17, "npc"), vp=viewport(layout.pos.row=1, layout.pos.col=1), gp=gpar(fontsize=9))
...
#write.table(group.simper.kw, "lab_group_krusk_simper.csv", sep=",")
```
